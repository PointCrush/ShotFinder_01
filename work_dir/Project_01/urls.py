...
urlpatterns = [
    ...
    path('accept/<int:project_pk>/<int:member_pk>/', accept_invitation, name='accept_invitation'),
    path('my_projects/', my_projects, name='my_projects'),
    path('edit_project/<int:project_pk>/', edit_project, name='edit_project'),
    path('edit_references/<int:project_pk>/', edit_references, name='edit_references'),
